...
(function($) {
  ...
  defaults = {
    ...
    table: {
      ...
      columns: null, //'FullName Gender Class Dormitory Tuitiondebt Edit View Delete',
  ...
  function InputsSearch(obj, settings) {
    ...
    this.create = function() {
      var $search = $('<input placeholder="search" class="form-control"/>', {
            type: 'search',
  ...
  function PaginationPerPage(obj, settings) {
    ...
    this.create = function() {
      ...
      }).append("<span class='dynatable-per-page-label pull-left form-group-sm '>" + settings.inputs.perPageText + "</span>").append($select);
    };
